 ...
 * CR_CollapseXML - [VSGallery](https://visualstudiogallery.msdn.microsoft.com/7e3487f8-6c4a-49a3-91e4-12d0261db260) \ [GitHub](https://github.com/RoryBecker/CR_CollapseXML) - Provides a command to collapse XML (or HTML) elements with an 'id' or 'name' attribute.
